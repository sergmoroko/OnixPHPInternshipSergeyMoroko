...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'description' => ['type' => 'text', 'length' => null, 'default' => null, 'null' => false, 'collate' => null, 'comment' => null, 'precision' => null],
        ...
        '_constraints' => [
            ...
            'categories_parent_id_fkey' => ['type' => 'foreign', 'columns' => ['parent_id'], 'references' => ['categories', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
    ];
    // phpcs:enable
    /**
